...
public class DashboardConfig {
     ...
     * 自定义环境变量
     */
    public static final String SENTINEL_RULE_FLOW_KEY = "sentinel.rule.flow.key";
    public static final String REDIS_HOST = "redis.host";
    public static final String REDIS_PORT = "redis.port";
    public static final String REDIS_PASSWORD = "redis.password";
    public static final String REDIS_PUBLISH_CHANNEL = "redis.publish.channel";
    ...
    public static String getRuleFlowKey() {
        return getConfigStr(SENTINEL_RULE_FLOW_KEY);
    }

    public static String getRedisHost() {
        return getConfigStr(REDIS_HOST);
    }

    public static String getRedisPort() {
        return getConfigStr(REDIS_PORT);
    }

    public static String getRedisPassword() {
        return getConfigStr(REDIS_PASSWORD);
    }

    public static String getRedisPublishChannel() {
        return getConfigStr(REDIS_PUBLISH_CHANNEL);
    }
